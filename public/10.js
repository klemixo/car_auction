            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return new Promise(function (resolve) {
                  _this.checkIfImageExists("https://phttt.vinfax.info/".concat(_this.carData.vin, "-").concat(_this.carData.stock.trim(), "-").concat(count, ".webp"), function (exists) {
                    if (exists) {
                      var imgUrl = "https://phttt.vinfax.info/".concat(_this.carData.vin.trim(), "-").concat(_this.carData.stock.trim(), "-").concat(count, ".webp").trim();
                      console.log(imgUrl);
