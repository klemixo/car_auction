<template>
    <div class="car__container container" v-if="carData">
        ...
        <div class="breadcrumbs">
            ...
            <a href="/" class="breadcrumb">Cars</a>
            <div class="breadcrumb breadcrumb--blue">></div>
            <a @click="searchByMake(carData.marka)" class="breadcrumb">
                {{ carData.marka }}
            </a>
            <div class="breadcrumb breadcrumb--blue">></div>
            <a @click="searchByModel(carData.model)" class="breadcrumb">{{
                carData.model
            }}</a>
            <div class="breadcrumb breadcrumb--blue">></div>
            <div class="breadcrumb breadcrumb--bold no-pointer">
            ...
            <div class="car__container__content__data">
                <div class="data__box card">
                    ...
                    <div class="data__box__content">
                        <h3>
                            Final bid: ${{ carData.final_bid | formatNumber }}
                        </h3>
                        <p class="highlight">
                ...
                <div class="data__box card">
                    ...
                    <div class="data__box__content">
                        <div class="flex-base">
                            ...
                            <p class="strong">
                                {{ carData.estimated_retail_value }}
                            </p>
                        </div>
                        <div class="flex-base">
                            <p class="light">Estimated repair cost</p>
                            <p class="strong">
                                {{ carData.estimated_repair_cost }}
                            </p>
                        </div>
                        <div class="flex-base">
...
export default {
    ...
    mounted() {
        document.title = `${this.make} | ${this.model} | ${this.vin}`;
        this.getCarData();
        this.setAutoplay();
    },
    methods: {
        searchByMake(marka) {
            store.commit("SET_FILTER", { key: "marka", value: marka });
            router.push("/");
        },
        searchByModel(model) {
            store.commit("SET_FILTER", { key: "model", value: model });
            router.push("/");
        },
        setAutoplay() {
            setInterval(() => {
